...
const Home = () => {
  ...
  return (
    <div className="w-full max-w-none px-4 space-y-6">
      ...
      >
        <h2 className="text-xl font-bold mb-2">👋 Good Morning, {userName}!</h2>
        <div className="bg-white/20 rounded-lg p-4">
          <p className="text-white/80 text-sm mb-2">💭 Daily Affirmation</p>
        ...
        <div className="grid grid-cols-3 gap-3 mb-4">
          {quickMoodOptions.map((option) => (
            <button
              ...
              className={`flex flex-col items-center p-4 rounded-lg border-2 transition-all duration-200 wellness-transition wellness-hover ${
                selectedMood === option.value
                  ? "border-[#A88CF0] shadow-lg"
                  : "border-gray-200 hover:border-[#F7C6D9]"
              }`}
              style={
                selectedMood === option.value
                  ? {
        ...
        <div className="space-y-3">
          {aiSuggestions.map((suggestion, index) => (
            <div
              ...
              style={{ backgroundColor: "var(--light-blue)", opacity: 0.5 }}
            >
        ...
        <div className="space-y-3">
          {recentActivity.map((activity, index) => (
            <div
              ...
              style={{ backgroundColor: "var(--light-blue)", opacity: 0.3 }}
            >
      ...
      <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-100">
        ...
        <div className="grid grid-cols-3 gap-4">
          {quickActions.map((action, index) => (
            <button
              key={index}
              className="flex flex-col items-center p-4 rounded-lg border-2 border-gray-200 hover:border-indigo-300 hover:shadow-md transition-all duration-200"
            >
              <div
